...
foreach($songs as $song){ ?>
  <div class="songs_unit row">
    ...
    <div class="col-2">
    <div class="svg">
      <svg xmlns="http://www.w3.org/2000/svg" height="20px" width="auto" viewBox="0 0 384 512">
    ...
    <div class='svg2'>
      <svg xmlns="http://www.w3.org/2000/svg" height="20px" width="auto" viewBox="0 0 320 512">
        <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
